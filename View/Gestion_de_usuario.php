                ...
                <article class="card animate__animated animate__zoomIn" style="animation-delay: 0.8s;">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" autocomplete="off" novalidate>
                            ...
                            <div class="mb-3"><label for="pantalla" class="form-label">Nivel de Acceso</label><select id="pantalla" name="pantalla" class="form-select" required><option value="" selected disabled>Seleccione...</option><option value="1">Despacho</option><option value="2">Validación</option><option value="3">Recepción</option><option value="0">Administrador</option><option value="4">Reportes</option><option value="5">Admin-limitado</option><option value="6">Reportes Faltantes</option><option value="8">Listo etiquetas</option><option value="10">Listo inventario</option><option value="11">Códigos de Barras</option><option value="12">Códigos de Referencia</option><option value="13">Gestión de Imágenes</option></select></div>
                ...
                <article class="card animate__animated animate__zoomIn" style="animation-delay: 0.9s;">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" autocomplete="off" novalidate>
                            ...
                            <div class="mb-3"><label for="pantalla_nuevo" class="form-label">Nuevo Nivel de Acceso</label><select id="pantalla_nuevo" name="pantalla_nuevo" class="form-select"><option value="-1" selected>Sin cambio</option><option value="1">Despacho</option><option value="2">Validación</option><option value="3">Recepción</option><option value="0">Administrador</option><option value="5">Admin-limitado</option><option value="4">Reportes</option><option value="6">Reporte de faltantes</option><option value="8">Listo etiquetas</option><option value="10">Listo inventario</option><option value="11">Códigos de Barras</option><option value="12">Códigos de Referencia</option><option value="13">Gestión de Imágenes</option></select></div>
