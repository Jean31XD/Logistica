<?php
/**
 * Reporte de Facturas - custinvoicejour
 * Dashboard de análisis y métricas de facturas
 */
...
if (!tieneModulo('reporte_facturas', $conn)) {
...
$pageTitle = "Reporte de Facturas | MACO";
...
<div class="bi-header">
    <div class="bi-header-info">
        <h1><i class="fas fa-file-invoice-dollar"></i> Reporte de Facturas</h1>
        <p>Análisis completo de facturas registradas en el sistema</p>
    </div>
