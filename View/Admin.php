...
<style>
    ...
    /* --- INICIO: SECCIÓN RESPONSIVA AÑADIDA --- */
    @media (max-width: 600px) {
        ...
        /* Oculta el texto para mostrar solo el ícono */
        .header-text {
            display: none;
        }

        /* Ajusta el botón de logout para que sea solo un círculo con el ícono */
        .floating-header .logout-btn {
            padding: 10px;
            border-radius: 50%;
        }
    ...
    /* --- FIN: SECCIÓN RESPONSIVA AÑADIDA --- */
</style>
</head>
<body>
